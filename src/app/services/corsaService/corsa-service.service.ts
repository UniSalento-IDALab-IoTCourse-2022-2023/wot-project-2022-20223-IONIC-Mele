...
export class CorsaServiceService {
  ...
  storico:Storico = {id: "", data: "", time: "", startTime: "", endTime: ""}
  ...
  async startCorsa(box:Box){
    ...
    try {
      ...
      this.storico.startTime = formattedTime;
  ...
  saveCorsa(elapsedTime:number, box:string) {
    ...
    const minutes = String(now.getMinutes()).padStart(2, '0');
    const formattedTime = `${hours}:${minutes}`;
    this.storico.endTime = formattedTime;
    ...
    this.storico = {id: "", data: "", time: "", startTime: "", endTime: ""}
    this.tempID = ""
  ...
  setBackEndParam(box:Box) {
    ...
    rangeBoxBackEnd.description = box.boxName
